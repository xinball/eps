(function (factory) {
  ...
  CropAvatar.prototype = {
    ...
    alert: function (msg) {
      var $alert = [
            '<div class="alert alert-danger alert-dismissible avater-alert">',
    ...
    success: function (msg) {
      var $success = [
            '<div class="alert alert-success alert-dismissible avater-alert">',
              '<i class="bi bi-check-circle-fill"></i>',
              msg,
            '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>'
          ].join('');

      this.$avatarUpload.after($success);
    }
  };
