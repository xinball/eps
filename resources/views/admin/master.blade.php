...
@if ($ladmin!==null&&($ladmin->utype==='s'||$ladmin->utype==='x'))
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ isset($aractive)&&$aractive?'active':'' }}" href="/admin/area">
                                <i class="bi bi-map-fill"></i> 管理区域
                            </a>
                        </li>
@if ($ladmin->utype==='x')
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ isset($oactive)&&$oactive?'active':'' }}" href="/admin/operation">
                                <i class="bi bi-menu-button-wide-fill"></i> 用户日志
                            </a>
                        </li>
                        <li class="nav-item">
