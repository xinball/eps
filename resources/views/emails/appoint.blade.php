                                    ...
                                    <tr>
                                        <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; color: #333333; font-size: 15px; font-weight: 400; line-height: 1.4; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 15px 5px;"
                                            ...
                                            <div id="cta">
                                                <p>
                                                    您收到一条预约/报备处理：
                                                    {{ $option['utype'] }} <a  href="{{ $var['vu'].$user->uid }}">{{ $user->uname }}</a> <a  href="mailto:{{ $user->uemail }}"> {{$user->uemail }}</a> {{$option['des'] }}
                                                </p>
                                                <p>
                                                    用户点击此链接，
                                                    <a href="{{ $var['vua'].'?aid='.$option['aid'] }}" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">查看预约/报备</a>
                                                </p>
                                                <p>
                                                    或复制此链接至浏览器打开：<br/><a href="{{ $var['vua'].'?aid='.$option['aid'] }}" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">{{ $var['vua'].'?aid='.$option['aid'] }}</a>
                                                </p>
                                                <p>
                                                </p>
                                                <p>
                                                    管理员点击此链接，
                                                    <a href="{{ $var['vaa'].'?aid='.$option['aid'] }}" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">查看预约/报备</a>
                                                </p>
                                                <p>
                                                    或复制此链接至浏览器打开：<br/><a href="{{ $var['vaa'].'?aid='.$option['aid'] }}" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">{{ $var['vaa'].'?aid='.$option['aid'] }}</a>
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
