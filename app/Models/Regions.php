...
class Regions extends Model
{
    ...
    static public function getRegionsByCid($city_id){
        return (new Regions())->where('city_id',$city_id)->get();
    }
}